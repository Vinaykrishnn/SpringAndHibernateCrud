...
<div id="demo" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
        <div class="carousel-item ">
            <img src="https://img.freepik.com/premium-vector/web-designer-developing-front-end-tech_143055-352.jpg?w=2000" alt="Los Angeles" width="1100" height="500">
        </div>
        <div class="carousel-item">
            <img src="https://thumbs.dreamstime.com/b/web-development-company-flat-concept-vector-illustration-software-engineering-d-cartoon-characters-design-testing-user-219186510.jpg" alt="Chicago" width="1100" height="500">
        </div>
        <div class="carousel-item active">
            <img src="https://media.gettyimages.com/vectors/web-development-vector-id473456596?s=2048x2048" alt="New York" width="1100" height="500">
        </div>
    </div>
